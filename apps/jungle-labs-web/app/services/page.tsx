...
export const metadata: Metadata = {
  title: "Services — AI Automation, CRM, Software & Analytics",
  description:
    "Jungle Labs builds AI automation systems, custom CRM platforms, analytics dashboards, and production-grade software for businesses in BC and across Canada.",
    ...
    <main>
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex rounded-full border border-white/20 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:border-cyan-300/35 hover:text-cyan-200"
              >
                Email Us
              </a>
            </div>
      ...
      <AnimatedSection className="section-shell mt-14">
        <div className="mb-6 max-w-3xl">
          ...
          <p className="mt-2 text-white/60">Each page is built around a high-intent search term with FAQs and schema markup.</p>
        </div>
