...
export const metadata: Metadata = {
  title: "French Learning Resources — Guides, Apps & Practice Tools",
  description: "French learning resources from Jungle Labs: beginner guides, speaking practice methods, app comparisons, and Franco downloads for macOS and Windows.",
  keywords: ["French learning resources", "learn French free", "French practice tools", "Franco app download"],
  alternates: { canonical: "/french-learning-resources" },
  openGraph: {
    title: "French Learning Resources — Jungle Labs",
    description: "Guides, speaking practice methods, app comparisons, and the Franco AI French learning app.",
    type: "article",
    url: "/french-learning-resources"
  }
};
