...
export const metadata: Metadata = {
  title: "How to Practice French Speaking Every Day",
  description: "Actionable methods to practice French speaking daily with AI prompts, repetition loops, and pronunciation feedback. Practice with Franco.",
  keywords: ["how to practice French speaking", "French speaking practice", "learn French speaking", "French pronunciation"],
  alternates: { canonical: "/how-to-practice-french-speaking" },
  openGraph: {
    title: "How to Practice French Speaking Every Day",
    description: "Daily speaking routines, AI prompt drills, and pronunciation feedback tips for French learners.",
    type: "article",
    url: "/how-to-practice-french-speaking"
  }
};
