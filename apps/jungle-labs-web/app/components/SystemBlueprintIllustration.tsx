...
export function SystemBlueprintIllustration() {
  return (
    <div className="glass-card relative overflow-hidden p-6">
      ...
      <div className="absolute -bottom-12 -right-8 h-48 w-48 rounded-full bg-emerald-300/10 blur-3xl" />
      ...
      <svg viewBox="0 0 520 300" className="relative z-10 h-auto w-full" aria-label="System blueprint">
        ...
        <rect x="210" y="115" width="110" height="70" rx="14" fill="rgba(3,10,18,0.9)" stroke="rgba(34,197,94,0.4)" />
        ...
        <rect x="375" y="50" width="100" height="52" rx="12" fill="rgba(3,10,18,0.8)" stroke="rgba(34,197,94,0.45)" />
        <rect x="70" y="225" width="110" height="52" rx="12" fill="rgba(3,10,18,0.8)" stroke="rgba(34,197,94,0.45)" />
      ...
      <div className="relative z-10 mt-4 grid grid-cols-2 gap-3 text-xs text-white/75">
        ...
        <div className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2"><Database className="h-3.5 w-3.5 text-emerald-300" /> Data Layer</div>
        <div className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2"><Globe className="h-3.5 w-3.5 text-emerald-300" /> Web Apps</div>
