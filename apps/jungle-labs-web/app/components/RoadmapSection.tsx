...
export function RoadmapSection() {
  return (
    <AnimatedSection className="section-shell mt-24">
      ...
      <div className="relative space-y-6 pl-6 before:absolute before:bottom-3 before:left-1.5 before:top-3 before:w-px before:bg-gradient-to-b before:from-emerald-300/60 before:to-emerald-300/20">
