...
const pillars = [
  ...
  },
  {
    ...
    accent: "from-emerald-300/40 to-emerald-300/40",
  ...
  },
  {
    ...
    accent: "from-emerald-300/40 to-green-300/40",
    tint: "text-emerald-300"
  },
  {
    icon: Fingerprint,
    ...
    accent: "from-lime-300/40 to-emerald-300/40",
    tint: "text-lime-300"
  }
];
...
function AnimatedChain() {
  ...
  return (
    <div className="relative h-56 w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-between px-4">
        {blocks.map((i) => (
          <motion.div
            ...
            className="relative"
          >
            <div className="relative h-28 w-24 rounded-xl border border-emerald-300/30 bg-[#06101c]/90 p-3 shadow-[0_18px_38px_-22px_rgba(34,197,94,0.7)]">
              {/* glow corner */}
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-emerald-300 to-transparent" />
              <div className="text-[9px] font-mono uppercase tracking-[0.12em] text-emerald-200/80">block #{1024 + i}</div>
              <div className="mt-2 space-y-1.5">
                <div className="h-1 w-full rounded-full bg-green-300/60" />
                <div className="h-1 w-3/4 rounded-full bg-emerald-300/60" />
                <div className="h-1 w-2/3 rounded-full bg-emerald-300/60" />
                <div className="h-1 w-1/2 rounded-full bg-emerald-300/40" />
              </div>
            ...
            {i < blocks.length - 1 && (
              <div className="absolute -right-7 top-1/2 h-px w-7 -translate-y-1/2 bg-gradient-to-r from-emerald-300/60 to-emerald-300/0" />
            )}
          </motion.div>
        ))}
      </div>
      ...
      >
        <Coins className="h-5 w-5 text-lime-300 drop-shadow-[0_0_8px_rgba(163,230,53,0.7)]" />
      </motion.div>
      <motion.div
      ...
      >
        <Layers className="h-5 w-5 text-green-300 drop-shadow-[0_0_8px_rgba(134,239,172,0.7)]" />
      </motion.div>
    </div>
  );
}
  ...
  return (
    <AnimatedSection id="blockchain" className="section-shell mt-28">
      <div className="mb-10 flex flex-col items-start gap-3 md:flex-row md:items-end md:justify-between">
        ...
        <a
          href="#contact"
          className="inline-flex items-center gap-2 rounded-full border border-green-300/35 bg-green-300/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-green-200 transition hover:border-green-300/55 hover:bg-green-300/15"
        >
          Talk to our team
        </a>
      </div>
