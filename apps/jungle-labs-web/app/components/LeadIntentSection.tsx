    ...
    <AnimatedSection className="section-shell mt-16">
      ...
      >
        ...
        <div className="relative grid gap-5 md:grid-cols-[1.25fr_0.75fr] md:items-center">
          <div>
            <p className="section-kicker">Free AI Planning Tool</p>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight text-white md:text-3xl">
              Get an AI-generated system plan in under 2 minutes
            </h2>
            <p className="mt-3 max-w-2xl text-white/75">
              Describe your business challenge and get a scoped build approach — automation, CRM, analytics, or custom software — delivered straight to your inbox.
            </p>
          </div>
          <a
            href="#ai-demo"
