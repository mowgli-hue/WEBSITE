...
export const metadata: Metadata = {
  title: "Newton Immigration — AI-Powered Canada Immigration Platform",
  description:
    "Newton Immigration is an AI-powered immigration platform with CRS calculator, Express Entry guidance, PNP program matching, and consultation booking for Canada and USA pathways.",
  keywords: [
    "Newton Immigration",
...
const serviceSchema = {
  ...
  description:
    "Newton Immigration is an AI-powered immigration platform offering Express Entry, PNP, work permit, study permit, and citizenship consulting for Canada.",
  provider: {
    "@type": "Organization",
    name: "Jungle Labs",
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What immigration programs does Newton Immigration cover?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Newton Immigration covers Express Entry, Provincial Nominee Programs (PNP), work permits, study permits, visitor visas, citizenship applications, and USA immigration pathways."
      }
    },
    {
      "@type": "Question",
      name: "Does Newton Immigration have a CRS score calculator?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Newton Immigration's platform includes a free CRS score calculator that estimates your Express Entry ranking and shows how to improve your profile for higher draw invitations."
      }
    },
    {
      "@type": "Question",
      name: "Can Newton Immigration help with visa refusals?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Where is Newton Immigration located?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Newton Immigration is headquartered in Surrey, BC with branch offices in Calgary, and international locations in Gajsinghpur and Zira."
      }
    }
  ]
};
...
const programs = [
  ...
  },
  {
    ...
    description: "Province-specific streams with +600 CRS point nominations. Newton maps your profile to the best-fit province.",
    ...
    <main>
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-cyan-300/10 bg-gradient-to-br from-cyan-400/8 via-black to-emerald-400/5 px-8 py-16 md:px-14 md:py-24">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
              Newton Immigration combines expert human consultants with AI-powered tools — CRS calculator, program
      ...
      <section className="section-shell mt-24">
        ...
        <p className="mt-4 max-w-2xl text-white/70">
          Newton Immigration is more than a consulting firm — it&apos;s a platform with live tools that help you
      ...
      <section className="section-shell mt-24">
        ...
        <h2 className="section-title">Common questions about Newton Immigration</h2>
