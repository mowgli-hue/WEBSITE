...
export const metadata: Metadata = {
  title: "Best App to Learn French — Franco by Jungle Labs",
  description: "What makes the best app to learn French: adaptive lessons, speaking feedback, and daily progression loops. Download Franco for macOS and Windows.",
  keywords: ["best app to learn French", "French learning app", "Franco app", "learn French AI"],
  alternates: { canonical: "/best-app-to-learn-french" },
  openGraph: {
    title: "Best App to Learn French — Franco by Jungle Labs",
    description: "Adaptive lessons, pronunciation feedback, and gamified progress. Download Franco free for macOS and Windows.",
    type: "article",
    url: "/best-app-to-learn-french"
  }
};
