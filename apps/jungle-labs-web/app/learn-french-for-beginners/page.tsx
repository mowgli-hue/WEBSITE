...
export const metadata: Metadata = {
  title: "Learn French for Beginners — Daily Routines & Franco App",
  description: "Beginner-friendly French learning roadmap with daily routines, speaking practice tips, and Franco app desktop downloads for macOS and Windows.",
  keywords: ["learn French for beginners", "beginner French guide", "Franco app", "French daily routine"],
  alternates: { canonical: "/learn-french-for-beginners" },
  openGraph: {
    title: "Learn French for Beginners — Jungle Labs",
    description: "A practical beginner roadmap: daily study habits, speaking routines, and the Franco AI app.",
    type: "article",
    url: "/learn-french-for-beginners"
  }
};
